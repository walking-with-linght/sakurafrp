            ...
            <section class="hero">
                ...
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0 is-revealing">John_San Panel</h1>
	                        <p class="hero-paragraph is-revealing">最新的 Frp 内网穿透管理面板</p>
                ...
                <div class="container">
                    <div class="features-inner section-inner has-top-divider">
						<div class="features-header text-center">
							<div class="container-sm">
								<h2 class="section-title mt-0">为什么选择 John_San Panel</h2>
						...
						<div class="testimonials-wrap">
							<div class="testimonial text-sm is-revealing">
								<div class="testimonial-inner">
									...
									<div class="testimonial-footer">
										<div class="testimonial-name"><a href="#">@托</a></div>
									</div>
								</div>
							</div>
							<div class="testimonial text-sm is-revealing">
								<div class="testimonial-inner">
									...
									<div class="testimonial-footer">
										<div class="testimonial-name"><a href="#">@也是托</a></div>
									</div>
								</div>
							</div>
							<div class="testimonial text-sm is-revealing">
								<div class="testimonial-inner">
									...
									<div class="testimonial-footer">
										<div class="testimonial-name"><a href="#">@还是托</a></div>
									</div>
								</div>
							</div>
							<div class="testimonial text-sm is-revealing">
							...
							<div class="testimonial text-sm is-revealing">
								<div class="testimonial-inner">
									...
									<div class="testimonial-footer">
										<div class="testimonial-name"><a href="#">@凑数的</a></div>
									</div>
								</div>
							</div>
							<div class="testimonial text-sm is-revealing">
								<div class="testimonial-inner">
									...
									<div class="testimonial-footer">
										<div class="testimonial-name"><a href="#">@全是托</a></div>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="pricing-table-inner">
										<div class="pricing-table-main">
											<div class="pricing-table-header mb-24 pb-24">
												...
												<div class="pricing-table-price"><span class="pricing-table-price-currency">￥</span><span class="pricing-table-price-amount h1">5</span>/月</div>
											</div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; <?php echo date("Y"); ?> John_San Panel</div>
                </div>
            </div>
        </footer>
    </div>
