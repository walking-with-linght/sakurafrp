                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
							...
							<div class="col-sm-6">
								<p><b>自定义域名</b> <small class="pdesc">仅限 HTTP 和 HTTPS 类型的隧道</small></p>
								<p><input type="text" class="form-control" id="domain" placeholder="test.example1.com,test.example2.com" /></p>
							</div>
							<div class="col-sm-6">
								<p><b>远程端口</b> <small class="pdesc">给访客连接时使用的外部端口 (<a href="javascript:loadPortRules();">查看规则</a>)</small></p>
								<p><input type="text" class="form-control" id="remote_port" placeholder="0" /></p>
							</div>
							<div class="card-body fix-text">
								<button type="button" class="btn btn-default" onclick="randomPort()">随机分配远程端口</button>
							</div>
							<div class="sub-heading">
								<span>高级设置</span>
							</div>
