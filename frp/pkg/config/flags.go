...
func RegisterServerConfigFlags(cmd *cobra.Command, c *v1.ServerConfig, opts ...RegisterFlagOption) {
	...
	//新增api接口John_San_Api
	cmd.PersistentFlags().StringVarP(&c.John_San_Api, "John_San_Api", "", "http://frpapi.demo.com", "John_San_Api")
	cmd.PersistentFlags().StringVarP(&c.John_San_Token, "John_San_Token", "", "john_san_token|1", "John_San_Token")
